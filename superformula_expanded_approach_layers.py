...
for i in range(num_samples):
    ...
    w_circ, w_sq, w_cross, w_dual, m_hollow, m_split, m_inv, m_layer = raw_samples[i, :8]

    # Next 11 parameters are constants, mapped to their specific physical bounds
    mapped_constants = []
    for j in range(11):
        raw_val = raw_samples[i, 8 + j]
...
fig.suptitle("19-Dimensional LHS Parameterized Shapes (with Layers)", fontsize=16)
